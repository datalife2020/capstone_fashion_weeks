...
class API(object):
    ...
    def solve_challenge(self):
        ...
        self.logger.info("Challenge requested for {}".format(self.username))
    ...
    def send_request(  # noqa: C901 make sleep minutes 0 when we do a request
        ...
        if response.status_code == 200:
            ...
            if response.status_code == 429:
                ...
                if not login: raise Exception('SoftBan')
                ...
                response_data = json.loads(response.text)
                if not login and response_data.get("message") != "Media is unavailable": raise Exception('SoftBan')
